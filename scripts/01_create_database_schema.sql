-- Create database schema for the rating system
-- This script sets up all required tables with proper relationships and constraints

-- Users table to store all user types (admin, normal user, store owner)
...
-- Stores table to store store information
...
-- Ratings table to store user ratings for stores
